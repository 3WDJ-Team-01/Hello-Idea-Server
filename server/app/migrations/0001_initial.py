# Generated by Django 2.1.5 on 2019-04-23 14:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_name', models.CharField(default='SOME STRING', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idea_color', models.CharField(default='#ECF0F1', max_length=30)),
                ('is_forked', models.IntegerField(default=0)),
                ('updated_at', models.DateTimeField(default=datetime.datetime(2019, 4, 23, 14, 22, 12, 441053, tzinfo=utc))),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
            options={
                'db_table': 'Idea',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_intro', models.CharField(default='', max_length=100)),
                ('project_img', models.CharField(max_length=200)),
                ('project_tendency', models.CharField(default='', max_length=50)),
                ('project_likes', models.IntegerField(default=0)),
                ('project_hits', models.IntegerField(default=0)),
                ('updated_at', models.DateTimeField(default=datetime.datetime(2019, 4, 23, 14, 22, 12, 439056, tzinfo=utc))),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
            options={
                'db_table': 'Project',
