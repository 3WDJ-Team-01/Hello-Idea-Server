...
urlpatterns = [
    ...
    path('notify/send/', Send_NotifyAPI.as_view()),
    path('notify/read/', Notify_readAPI.as_view()),
    path('request/send/', Send_RequestAPI.as_view()),
    ...
    path('idea/root/select/', Idea_rootAPI.as_view()),
    path('idea/root/update/', Idea_rootUpdateAPI.as_view()),
    path('project/img/update/', Project_imgUpdateAPI.as_view()),
    path('idea/info/', Idea_infoAPI.as_view()),
    path('idea/history/delete/', Idea_forkDeleteAPI.as_view()),
    path('notify/all/read/', Notify_readALLAPI.as_view()),
    path('idea/file/upload/', file_uploadAPI.as_view()),
    path('idea/file/select/', Idea_fileSelectAPI.as_view()),
